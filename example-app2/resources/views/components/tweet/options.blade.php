        ...
        <div class="bg-white rounded shadow-md absolute right-0 w-24 z-20 pt-1 pb-1">
            ...
            <div>
                <form action="{{ route('tweet.delete', ['tweetId' => $tweetId]) }}" method="post"
                    ...
                    @method('DELETE')
                    @csrf
                    <button type="submit" class="flex items-center w-full pt-1 pb-1 pl-3 pr-3 hover:bg-red-200">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
@once
    @push('css')
        <style>
            ...
            .tweet-option>summary::webkit-details-marker {
                display: none;
            }
